...
export default function ExpiredPage() {
  return (
    <>
      <AuthCardHeader stepLabel="Link expired" />
      <div style={{ flex: "none", padding: "26px 0 4px" }}>
        <div style={{ minWidth: 0 }}>
          ...
          <h1 style={{ fontSize: 34, fontWeight: "var(--w-bold)" as never, letterSpacing: "-0.04em", lineHeight: 1.08, margin: "0 0 12px", textAlign: "center" }}>This link has expired</h1>
          <p style={{ fontSize: 15, color: "var(--txt-2)", lineHeight: 1.6, margin: "0 0 24px", textAlign: "center" }}>
            Links last fifteen minutes and work once. Nothing is wrong with your account — request a fresh one.
          </p>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 12, background: "var(--warn-tint)", borderRadius: "var(--r2)", padding: "18px 20px", marginBottom: 26 }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 14, fontWeight: "var(--w-semi)" as never, color: "var(--warn)" }}>Only the newest link works</div>
              <div style={{ fontSize: 13.5, color: "var(--txt-2)", lineHeight: 1.55, marginTop: 3 }}>
                If you requested more than one link, every earlier email stopped working. Use the most recent one, or start again below.
              </div>
            </div>
          </div>
