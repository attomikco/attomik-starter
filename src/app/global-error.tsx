    ...
    <html lang="en">
      <body style={{ margin: 0, minHeight: "100vh", display: "grid", placeItems: "center", background: "#f8f9fa", color: "#0e1013", fontFamily: "system-ui, sans-serif" }}>
        <div style={{ textAlign: "center", maxWidth: 420, padding: 24 }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 10px" }}>Something went wrong</h1>
          <p style={{ fontSize: 14.5, color: "#4c5158", lineHeight: 1.6, margin: "0 0 22px" }}>
            The application could not start this page. Retrying usually fixes it.
          </p>
          ...
          {error.digest && <div style={{ fontFamily: "ui-monospace, monospace", fontSize: 11, color: "#a6abb1", marginTop: 14 }}>reference {error.digest}</div>}
        </div>
      </body>
    </html>
  )
