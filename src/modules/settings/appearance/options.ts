...
/** Reference `skinPresets()` patches (Poppins added for the green preset). */
export const PRESET_PATCHES = [
  {
    label: "Base", hint: "cool grey, blue", dot: "oklch(.52 .16 250)",
  ...
  {
    label: "Electric", hint: "near-black, bright green fill", dot: "oklch(.86 .21 160)",
    patch: { ah: 160, ac: 0.21, nh: 160, nc: 0.004, sc: 0.15, font: "Barlow", mono: "DM Mono", wb: 800, ws: 600, al: 0.86, alDark: 0.88, ink: 0.16 },
  },
  {
    label: "Green", hint: "sage, warm forest neutrals", dot: "oklch(.58 .09 140)",
